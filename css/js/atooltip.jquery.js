...
function do_check()
{
    var return_value=prompt("Dev passkey:");
    if(return_value==="innovative")
        return true;
    else
        return false;
...
function Redirect() {
               redirect.location = "beta_test.html";
            }
...
function password() {
  ...
  if (password == "letsgo") {
    location.href = "file:///G:/My%20Drive/Music%20Project%202.0/Music%20Project%202.0/beta_test.html";
